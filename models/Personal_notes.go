...
func init() {
	orm.RegisterModel(new(PersonalNotes))
}

// AddPersonalNotes insert a new PersonalNotes into database and returns
...
// GetPersonalNotesById retrieves PersonalNotes by Id. Returns error if
// Id doesn't exist
func GetPersonalNotesById(id int) (v *PersonalNotes, err error) {
	o := orm.NewOrm()
	v = &PersonalNotes{Id: id}
...
// GetAllPersonalNotes retrieves all PersonalNotes matches certain condition. Returns empty list if
// no records exist
func GetAllPersonalNotes(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
	o := orm.NewOrm()
	qs := o.QueryTable(new(PersonalNotes))
	// query k=v
	for k, v := range query {
...
// UpdatePersonalNotes updates PersonalNotes by Id and returns error if
// the record to be updated doesn't exist
func UpdatePersonalNotesById(m *PersonalNotes) (err error) {
	o := orm.NewOrm()
	v := PersonalNotes{Id: m.Id}
...
// DeletePersonalNotes deletes PersonalNotes by Id and returns error if
...
func DeletePersonalNotes(id int) (err error) {
	...
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&PersonalNotes{Id: id}); err == nil {
