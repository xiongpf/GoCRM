...
func init() {
	orm.RegisterModel(new(PublicNotice))
}

// AddPublicNotice insert a new PublicNotice into database and returns
...
// GetPublicNoticeById retrieves PublicNotice by Id. Returns error if
// Id doesn't exist
func GetPublicNoticeById(id int) (v *PublicNotice, err error) {
	o := orm.NewOrm()
	v = &PublicNotice{Id: id}
...
// GetAllPublicNotice retrieves all PublicNotice matches certain condition. Returns empty list if
// no records exist
func GetAllPublicNotice(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
	o := orm.NewOrm()
	qs := o.QueryTable(new(PublicNotice))
	// query k=v
	for k, v := range query {
...
// UpdatePublicNotice updates PublicNotice by Id and returns error if
// the record to be updated doesn't exist
func UpdatePublicNoticeById(m *PublicNotice) (err error) {
	o := orm.NewOrm()
	v := PublicNotice{Id: m.Id}
...
// DeletePublicNotice deletes PublicNotice by Id and returns error if
...
func DeletePublicNotice(id int) (err error) {
	...
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&PublicNotice{Id: id}); err == nil {
